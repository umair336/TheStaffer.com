                                                              ...
                                                              Padding(
                                                                padding:
                                                                    const EdgeInsets
                                                                        ...
                                                                        0),
                                                                child: Text(
                                                                  snapshot.data.data[0].assignments[index].jobTitle
                                                                              .toString() !=
                                                                          null
                                                                      ? snapshot
                                                                          .data
                                                                    ...
                                                                    return Padding(
                                                                      ...
                                                                      child: Text(
                                                                          snapshot.data.data[0].assignments[index].startDate != null
                                                                              ? DateFormat(snapshoot.data.data[0].currentDateFormat).format(DateTime.parse(snapshot.data.data[0].assignments[index].startDate))
                                                                              : ' - - - ',
